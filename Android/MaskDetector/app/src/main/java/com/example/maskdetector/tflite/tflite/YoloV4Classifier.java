package com.example.maskdetector.tflite.tflite;
...
import com.example.maskdetector.tflite.env.Utils;
...
public class YoloV4Classifier implements Classifier {
    ...
    // config yolov4 tiny
    private static final int[] OUTPUT_WIDTH_TINY = new int[]{10647, 10647};
